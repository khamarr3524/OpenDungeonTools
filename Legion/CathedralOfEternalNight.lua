...
ODT.dungeonTotalCount[dungeonIndex] = {normal=305,teeming=335,teemingEnabled=true}
ODT.dungeonBosses[dungeonIndex] = { --Cathedral of Eternal Night
	[2] = {
		[1] = {
			["name"] = "Agronox",
			["encounterID"] = 1905,
...
ODT.dungeonEnemies[dungeonIndex] = { --Cathedral of Eternal Night
	[1] = {
