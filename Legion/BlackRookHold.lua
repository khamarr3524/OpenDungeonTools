...
local pi = math.pi
ODT.dungeonTotalCount[dungeonIndex] = { normal=300, teeming=360, teemingEnabled=true}
ODT.dungeonBosses[dungeonIndex] = {--Black Rook Hold
	[1] = {
		[1] = {
...
ODT.dungeonEnemies[dungeonIndex] = { --Black Rook Hold
	[1] = {
