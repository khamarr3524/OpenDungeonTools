...
local pi = math.pi
ODT.dungeonTotalCount[dungeonIndex] = {normal=206,teeming=242,teemingEnabled=true}
ODT.dungeonBosses[dungeonIndex] = {--Eye of Azshara
	[1] = {
		[1] = {
...
ODT.dungeonEnemies[dungeonIndex] = { --Eye of Azshara
	[1] = {
