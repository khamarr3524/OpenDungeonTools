...
local pi = math.pi
ODT.dungeonTotalCount[dungeonIndex] = {normal=280,teeming=336,teemingEnabled=true}
ODT.dungeonBosses[dungeonIndex] = {--Darkheart Thicket
	[1] = {
		[1] = {
...
ODT.dungeonEnemies[dungeonIndex] = { --Darkheart Thicket
	[1] = {
