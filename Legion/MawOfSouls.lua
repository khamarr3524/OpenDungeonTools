...
local pi = math.pi
ODT.dungeonTotalCount[dungeonIndex] = {normal=150,teeming=180,teemingEnabled=true}
ODT.dungeonBosses[dungeonIndex] = {--Maw of Souls
	[1] = {
		[1] = {
...
ODT.dungeonEnemies[dungeonIndex] = { --Maw of Souls
	[1] = {
